...
pyinstaller --name EbookTalker --noconfirm --noupx --onedir --windowed --distpath "..\EbookTalker-Win64" --icon ".\static\favicon.ico" --splash ".\static\book.png" --add-data "C:\Python313\Lib\site-packages\transliterate;transliterate" --add-data "silero_stress;silero_stress" --version-file .\data\tmp\versionInfo.rc .\desktop.py
